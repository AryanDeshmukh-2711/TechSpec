# TechSpec — developer guide

How TechSpec works inside: the scoring engine, the data, the tests and the design rules.
For what TechSpec is and why, start with the [README](../README.md).
